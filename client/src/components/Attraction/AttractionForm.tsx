    ...
    <main className={`form-attraction-main-container ${theme}`}>
      ...
      >
        <section className="form-attraction-section">
          <label htmlFor="name" className={`label-attractions-form ${theme}`}>
            Nom de l'attraction :{" "}
          </label>
          <input
            type="text"
            ...
            className={`form-admin-attraction ${theme}`}
          />
        </section>
        <section className="form-attraction-section">
          <label htmlFor="name" className={`label-attractions-form ${theme}`}>
